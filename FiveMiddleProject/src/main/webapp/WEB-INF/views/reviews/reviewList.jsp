						...
						<div class="flex-w flex-t p-b-68">
							...
							<div class="size-207">
								<div class="flex-w flex-sb-m p-b-17">
									<span class="mtext-107 cl2 p-r-20" name=reviewWriter>
										${r.reviewWriter } </span> <span class="fs-18 cl11"> <i
										class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i> <i
										class="zmdi zmdi-star"></i> <i class="zmdi zmdi-star"></i> <i
										class="zmdi zmdi-star-half"></i>
									</span>
								</div>
								<p class="stext-102 cl6" name=reviewSubject>${r.reviewSubject }</p>
							</div>
							<br> <br> <br>
							<div>
									<button type="button" onclick="location.href='reviewDelete.do?reviewNum=${r.reviewNum }'">글삭제</button>
									<button type="button" onclick="location.href='reviewEditForm.do?reviewNum=${r.reviewNum }'">글수정</button>
