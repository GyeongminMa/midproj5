				...
				<table class="board-table">
					<thead>
						<tr>
							...
							<th scope="col" class="th-num">선택 삭제</th>
						...
						<c:if test="${not empty list }">
							<c:forEach items="${list }" var="list">
								<tr>
									...
									<td align="center"><input type="button" value="수정" onclick=""></td>
									<td align="center"><input type="button" value="삭제" onclick="delAjaxFnc()"></td>
