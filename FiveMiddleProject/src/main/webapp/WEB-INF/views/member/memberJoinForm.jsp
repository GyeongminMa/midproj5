			...
			<form id="frm" action="memberJoin.do" onsubmit="return formCheck()"
				...
				<div class="form_txtInput">
							...
							<tbody>
								...
								<tr class="email">
									...
									<td><input type="text" class="email" placeholder="이메일"
										id="memberId2" name="memberId2" required="required">
										
										<input type="hidden" class="email" placeholder="이메일"
										id="memberId" name="memberId" required="required">
										
										 <span
										class="mar10">@ </span> <input type="text"
										class="email email2" id="domain-txt" placeholder="">&nbsp;&nbsp;
								...
								<tr>
									<th><span>이름</span></th>
									<td><input type="text" placeholder="이름을 입력해주세요." id="memberName"
								...
								<tr>
									...
									<td><input type="text" class="nickname"
										...
										<button class="btn_confirm" onclick="nickChk()" id="btnNick"
											value="No">닉네임 중복확인</button></td>
								</tr>
								<tr>
									<th><span>비밀번호</span></th>
									<td><input type="password" id="memberPassword"
										name="memberPassword" required="required"
										placeholder="8자리 이상 필수 입력"></td>
								</tr>
								<tr>
									<th><span>비밀번호 확인</span></th>
									<td><input type="password" id="passwordChk"
										required="required" placeholder="비밀번호를 한 번 더 입력해주세요."></td>
								</tr>
								...
								<tr>
									<th><span>성별</span></th>
									<td><input type="text" id="memberGender"
										name="memberGender" placeholder="남자 or 여자 임시성별"></td>
								</tr>
								<tr>
							</tbody>
						</table>
					...
					<div class="btn_wrap">
						...
						&nbsp;&nbsp;
						<button class="btn_confirm email" type="button"
							onclick="location.href='main.do'">메인으로</button>
					</div>
				</div>
			</form>
			<!-- form_txtInput E -->
